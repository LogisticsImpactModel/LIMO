...
// * @author Ben
// */
//public class LegTypeNodeTest {
//    
//    public LegTypeNodeTest() {
//    }
//    
//    @BeforeClass
...
//
//    /**
//     * Test of getIcon method, of class LegTypeNode.
//     */
//    @Test
//    public void testGetIcon() {
//         try {
//            LegTypeNode ltn = new LegTypeNode(new LegType());
//            try {
//                //load orig. icon what we are looking for for comparison
//                BufferedImage sourceImg = ImageIO.read(new File("src/main/resources/icons/LegType_32x32.png"));
//                //get appl. icon in CostCategoryNode class w/ type 2 (32x32)
//                BufferedImage buffImg = (BufferedImage) ltn.getIcon(2);
