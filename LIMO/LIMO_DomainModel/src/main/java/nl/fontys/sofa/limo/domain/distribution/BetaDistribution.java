 ...
 */
public class BetaDistribution extends DistributionType {
    ...
    protected void calculateProbability() {
        ...
        probabilityResultCache = new org.apache.commons.math3.distribution.BetaDistribution(alpha, beta).probability(x0, x1);
    }
}
