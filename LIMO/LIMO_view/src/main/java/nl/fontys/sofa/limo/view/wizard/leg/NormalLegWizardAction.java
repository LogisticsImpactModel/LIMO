...
@ActionID(category = "Leg", id = "nl.fontys.limo.view.wizzard.leg.NormalLegWizardAction")
...
public final class NormalLegWizardAction implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        panels.add(new NormalLegWizardPanel1());
        panels.add(new NormalLegWizardPanel2());
