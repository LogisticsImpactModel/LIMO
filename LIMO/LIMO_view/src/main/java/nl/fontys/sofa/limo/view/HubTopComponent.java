 ...
 */
@ConvertAsProperties(
		dtd = "-//nl.fontys.sofa.limo.view//Hub//EN",
		autostore = false
)
...
@ActionID(category = "Window", id = "nl.fontys.sofa.limo.view.HubTopComponent")
...
@Messages({
	"CTL_HubAction=Hubs",
	"CTL_HubTopComponent=Hubs",
	"HINT_HubTopComponent=Manage Hubs"
})
public final class HubTopComponent extends TopComponent implements
