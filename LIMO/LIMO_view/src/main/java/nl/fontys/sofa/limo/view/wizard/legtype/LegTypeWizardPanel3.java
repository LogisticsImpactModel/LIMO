...
public class LegTypeWizardPanel3 implements WizardDescriptor.Panel<WizardDescriptor> {

    /**
     * The visual component that displays this panel. If you need to access the
     * component from this class, just use getComponent().
     */
    private LegTypeVisualPanel3 component;
    ...
    @Override
    public LegTypeVisualPanel3 getComponent() {
        if (component == null) {
            component = new LegTypeVisualPanel3();
        }
        return component;
    }
