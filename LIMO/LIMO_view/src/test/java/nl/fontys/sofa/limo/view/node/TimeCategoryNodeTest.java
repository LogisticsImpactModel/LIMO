 ...
 * @author Ben
 */
public class TimeCategoryNodeTest {
    
    public TimeCategoryNodeTest() {
    }
    ...
    /**
     * Test of getIcon method, of class TimeCategoryNode.
     */
    @Test
    public void testGetIcon() {
        System.out.println("getIcon");
        try {
            TimeCategoryNode tcn = new TimeCategoryNode(new TimeCategory());
            try {
                //load orig. icon what we are looking for for comparison
                BufferedImage sourceImg = ImageIO.read(new File("src/main/resources/icons/TimeCategory_32x32.png"));
                //get appl. icon in CostCategoryNode class w/ type 2 (32x32)
                BufferedImage buffImg = (BufferedImage) tcn.getIcon(2);
